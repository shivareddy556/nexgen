      ...
      <div className='home_card3_bg'>
        <div className='home_bg_images'>
          <div className='tdi9mq0 tdi9mq4d py-4'>
            <div className='Covering_hme_font py-3'>Top <span className='Design_home_font'>Design and Development</span> Company <br />Covering India and its Vicinity</div>
            <div className='Nexgen_home_at text-center'>At Nexgen, we specialize in Custom Web Design solutions tailored to your specific <br />needs. Our team crafts Responsive Web Designs that adapt seamlessly across </div>
            <div className='button_flex_homeget'>
              <button className='Proposal_home_button'>Get Proposal</button>
              <button className='Proposal_home_button1'>Get Website Audit</button>
            </div>
          </div>
          <div className='py-2'>
            <ScrollCarousel
        ...
        <div className='home_gride_bg_color'>
          <div className='home_gride tdi9mq0 py-4'>
            <div>
              <div className='home_yourfont1'>Your <span className='home_yourfont1_Expert'>Expert Web Design & Development</span> Partner</div>
            ...
            <div className='py-3'>
              <img src={nexgen_log_seection} alt='nexgen_log_seection' className='Homeimage5_style' />
